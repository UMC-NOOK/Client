      ...
      <div className="flex flex-1 justify-between py-2">
        <div className="flex flex-col justify-between">
          <div className="space-y-3">
            ...
            <p className="text-sm text-nook-100 flex items-center">
              {publisher}
