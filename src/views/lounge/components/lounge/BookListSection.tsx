            ...
            <div className="relative w-full group">
                ...
                <button
                    ...
                    <svg 
                        ...
                        <path d="M8.75 3.75L2.5 10M2.5 10L8.75 16.25M2.5 10H17.5" stroke="#B7E3E6" stroke-width="1.36364" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
                ...
                <button
                    ...
                    <svg 
                        className="flex w-10 h-10"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
                        <path d="M11.25 3.75L17.5 10M17.5 10L11.25 16.25M17.5 10H2.5" stroke="#B7E3E6" stroke-width="1.36364" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
