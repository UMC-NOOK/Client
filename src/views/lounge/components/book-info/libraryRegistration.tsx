      ...
      <div className="w-[440px] flex flex-col justify-start items-center bg-[rgba(45,40,34,1)] rounded-2xl px-17 relative">
        ...
        <div className="flex flex-col items-start justify-center w-full gap-5 mb-12">
          ...
          <div className="flex items-center justify-between w-full gap-[11px]">
            <button className={`w-[117px] h-[38px] rounded border border-solid border-nook-br-100 px-10 py-2  text-center text-sm not-italic font-normal leading-[22px] ${readingStatus === 1 ? 'bg-nook-br-100 text-white' : 'text-[rgba(255,255,255,0.50)]'}`} 
onClick={() => setReadingStatus(1)}>
              독서중
            </button>
            <button className={`w-[117px] h-[38px] rounded border border-solid border-nook-br-100 px-10 py-2 text-center text-sm not-italic font-normal leading-[22px] ${readingStatus === 2 ? 'bg-nook-br-100 text-white' : 'text-[rgba(255,255,255,0.50)]'}`} onClick={() => setReadingStatus(2)}>
              완독
            </button>
            <button className={`w-[117px] h-[38px] rounded border border-solid border-nook-br-100 px-10 py-2 text-center text-sm not-italic font-normal leading-[22px] ${readingStatus === 3 ? 'bg-nook-br-100 text-white' : 'text-[rgba(255,255,255,0.50)]'}`} onClick={() => setReadingStatus(3)}>
              찜
            </button>
          </div>
        </div>
